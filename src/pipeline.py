...
from src.forecast.baseline import build_forecast
...
def _build_summary(stats_df, risk_df, plan_df) -> str:
...
- Average observed price across fruits: {avg_price} yuan/kg
...
- Data note: this run uses the Kaggle archive in `data/raw/archive.zip`
"""
...
def run_pipeline() -> None:
    ...
    export_summary(_build_summary(stats_df, risk_df, plan_df), SUMMARY_FILE)
